...
CREATE TABLE RECEIVETXN(RECEIVETXNID INTEGER,ITEM VARCHAR2(100),ITEMDECS VARCHAR2(100),UOM VARCHAR2(100),LPN VARCHAR2(100),SUBINV VARCHAR2(100),LOCATOR VARCHAR2(100),QTY VARCHAR2(100),LOTCONTROL VARCHAR2(100),SERIALCONTROL VARCHAR2(100),DOCREFLINE VARCHAR2(100),SHIPMENTLINE VARCHAR2(100));
CREATE TABLE RECEIVETXNLINES(RECEIVETXNID INTEGER,ORGCODE VARCHAR2(100),DOCTYPE VARCHAR2(100),DOCREF VARCHAR2(100),VENDOR VARCHAR2(100),CUSTOMER VARCHAR2(100),CARRIER VARCHAR2(100),PACKINGSLIP VARCHAR2(100),BOL VARCHAR2(100),WAYAIRBILL VARCHAR2(100),SHIPMENTNUM VARCHAR2(100),SHIPPEDDATE VARCHAR2(100),COMMENTS VARCHAR2(100));
