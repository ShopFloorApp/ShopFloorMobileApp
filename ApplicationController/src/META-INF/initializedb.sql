...
CREATE TABLE SUBINVENTORYTXN(TRXNID INTEGER PRIMARY KEY AUTOINCREMENT, ISNEWENTITY VARCHAR2(1), ROWOPERATION VARCHAR2(20), FROMINVENTORY VARCHAR2(240), TOINVENTORY VARCHAR2(240), ITEMNUMBER VARCHAR2(240), ITEMNAME VARCHAR2(240), QUANTITY VARCHAR2(240), TXNTIME VARCHAR2(240), COMPLETEFLAG VARCHAR2(1), LPN VARCHAR2(240), FROMLOC VARCHAR2(240), TOLOC VARCHAR2(240), STATUS VARCHAR2(240),TXNUOM VARCHAR2(240));
...
CREATE TABLE MISCTXN(TRXNID INTEGER PRIMARY KEY AUTOINCREMENT,  FROMINVENTORY VARCHAR2(240), LOCATOR VARCHAR2(240), ITEMNUMBER VARCHAR2(240), ITEMNAME VARCHAR2(240), QUANTITY VARCHAR2(240), TXNTIME VARCHAR2(240), COMPLETEFLAG VARCHAR2(1), TRXTYPE VARCHAR2(240), ACCOUNTALIAS VARCHAR2(240), STATUS VARCHAR2(240));
CREATE TABLE LPNTXN(TRXNID INTEGER PRIMARY KEY AUTOINCREMENT,  SUBINVENTORY VARCHAR2(240), LOCATOR VARCHAR2(240), LPNFROM VARCHAR2(240), LPNTO VARCHAR2(240), QUANTITY VARCHAR2(240), TXNTIME VARCHAR2(240), ORGCODE VARCHAR2(1), TRXTYPE VARCHAR2(240));
CREATE TABLE ITEMTXN(ITEMID INTEGER,TRXNID INTEGER, ITEMNUMBER VARCHAR2(240), UOM VARCHAR2(240),QUANTITY INTEGER, TRXTYPE VARCHAR2(240),PRIMARY KEY(ITEMID,TRXTYPE));
