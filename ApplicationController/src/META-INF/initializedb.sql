...
CREATE TABLE LINES(ROWLINEIDX INTEGER,LINES VARCHAR2(100),SUBINV VARCHAR2(100),LOCATOR VARCHAR2(100),QUANTITY VARCHAR2(100),UOM VARCHAR2(100),LPN VARCHAR2(100),ISNEWENTITY VARCHAR2(100),RECEIVETXNID INTEGER,DOCREFLINE VARCHAR2(10),SHIPMENTLINE VARCHAR2(10));
