...
CREATE TABLE LPNTXN(TRXNID INTEGER PRIMARY KEY AUTOINCREMENT,  SUBINVENTORY VARCHAR2(240), LOCATOR VARCHAR2(240), LPNFROM VARCHAR2(240), LPNTO VARCHAR2(240), ITEMNUMBER VARCHAR2(240), ITEMNAME VARCHAR2(240), QUANTITY VARCHAR2(240), TXNTIME VARCHAR2(240), ORGCODE VARCHAR2(1), TRXTYPE VARCHAR2(240),TXNUOM VARCHAR2(240), SERIALCONTROL VARCHAR2(240), LOTCONTROL VARCHAR2(240));
