...
CREATE TABLE JOBOPERATION(JOBNUMBER VARCHAR2(10), JOBOPS VARCHAR2(50), JOBDESC VARCHAR2(50),JOBSTATUS VARCHAR2(10), READYSTATUS VARCHAR2(10), ASSEMBLY VARCHAR2(30), ASSEMBLYDESC VARCHAR2(30), SCHSTARTDATE VARCHAR2(30), NEXTOPSEQ VARCHAR2(10), COMPSUBINV VARCHAR2(20), COMPLOCATOR VARCHAR2(20), ASSEMBLYUOM VARCHAR2(10), LASTDEPT VARCHAR2(20), LASTOPSEQ VARCHAR2(10), NEXTDEPT VARCHAR2(20), OPSEQ VARCHAR2(10), QTYOP VARCHAR2(10), QTYCOMPLETED VARCHAR2(10), QTYQUEUE VARCHAR2(10), QTYSCRAPPED VARCHAR2(10),QTYRUN VARCHAR2(10),QTY2MOVE VARCHAR2(10), QTYCSCRAPQTY VARCHAR2(10), QTYREJECTED VARCHAR2(10), PRIMARY KEY(JOBNUMBER));
